...
task_description = """Площа Чорного моря становить 436 402 км²,
а площа Азовського моря становить 37 800 км².
...
print(f"Рішення задачі: Чорне та Азовське моря разом займають {total_ukrainian_seas_area} км2")
...
вартість комп’ютера.
"""
task_description = """Михайло разом з батьками вирішили купити комп’ютер, ско-
риставшись послугою «Оплата частинами». Відомо, що сплачу-
вати необхідно буде півтора року по 1179 грн/місяць.
...
print(f"Рішення задачі: Bартість комп’ютера складає: {computer_cost} грн")
...
task_description = """Іринка, готуючись до свого дня народження, склала список того,
що їй потрібно замовити. Обчисліть, скільки грошей знадобиться
для даного її замовлення.
...
big_pizza_amount = 4
big_pizza_price = 274
total_big_pizza_price = big_pizza_amount * big_pizza_price
middle_pizza_amount = 2
middle_pizza_price = 218
total_middle_pizza_price = middle_pizza_amount * middle_pizza_price
juice_amount = 4
juice_price = 35
total_juice_price = juice_amount * juice_price
cake_amount = 1
cake_price = 350
total_cake_price = cake_amount * cake_price
water_amount = 3
water_price = 21
total_water_price = water_amount * water_price
total = total_big_pizza_price + total_middle_pizza_price + total_juice_price + total_cake_price + total_water_price
print(f"Рішення задачі: Для данного замовлення знадобіться {total} грн")
...
"""
task_description = """Ігор займається фотографією. Він вирішив зібрати всі свої 232
фотографії та вклеїти в альбом. На одній сторінці може бути
розміщено щонайбільше 8 фото. Скільки сторінок знадобиться
Ігорю, щоб вклеїти всі фото?"""
print(task_description)
...
pages = 232 // 8
print(f"Рішення задачі: Ігорю знадобиться {pages} сторінок, щоб вклеїти всі фото")
...
ний бак?
"""
task_description = """Родина зібралася в автомобільну подорож із Харкова в Буда-
пешт. Відстань між цими містами становить 1600 км. Відомо,
що на кожні 100 км необхідно 9 літрів бензину. Місткість баку
становить 48 літрів.
