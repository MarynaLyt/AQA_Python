...
print("Hello", end = " ")
print("world!") # не потрібний відступ
...
for letter in "Hello world!":
    print(letter, end="")
# for це позначення циклу, end="" для того щоб друкувалось в одному рядку
...
everning_temperature = afternoon_temperature + 4
print(everning_temperature)
# task 09
"""
...
absent_boys = 1
absent_girls = 2
total_pupils_amount = boys+girls-absent_boys-absent_girls
print(total_pupils_amount)
# task 10
"""
